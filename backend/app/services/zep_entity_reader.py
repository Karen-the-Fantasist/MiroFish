...
from ..adapters import ZepGraphAdapter
...
class ZepEntityReader:
    ...
    def get_all_nodes(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        nodes = self.client.node.get_by_graph_id(graph_id=graph_id)
    ...
    def get_all_edges(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        edges = self.client.edge.get_by_graph_id(graph_id=graph_id)
    ...
    def get_node_edges(self, node_uuid: str) -> List[Dict[str, Any]]:
        ...
        try:
            edges = self._call_with_retry(
                func=lambda: self.client.node.get_entity_edges(node_uuid=node_uuid),
    ...
    def get_entity_with_context(
        ...
        try:
            node = self._call_with_retry(
                func=lambda: self.client.node.get(uuid_=entity_uuid),
